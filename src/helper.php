...
if (LOGGING) {
	$logfile = fopen(__DIR__ . LOGFILE, "a");
	fputs($logfile, "\nLOGGING START\n\n");
	fclose($logfile);
...
function mime_type($file) {
	...
	if (
		(parse_url($file, PHP_URL_SCHEME) === "http" || parse_url($file, PHP_URL_SCHEME) === "https") &&
	...
	$extension = strtolower(
		pathinfo(
			parse_url($file, PHP_URL_PATH), PATHINFO_EXTENSION
		)
	);
	if (isset($mime_type[$extension])) {
		return $mime_type[$extension];
	} else {
		info("warn", "Warning: Unknown file type for " . $file . ", defaulting to text/html");
		return "text/html";
	}
}
